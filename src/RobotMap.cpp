...
Servo* RobotMap::eagleWingsLeftServo = NULL;
Servo* RobotMap::eagleWingsRightServo = NULL;
...
DoubleSolenoid* RobotMap::liftshifter = NULL;
...
void RobotMap::init() {
	...
	eagleWingsLeftServo = new Servo(8);
	...
	liftpusher = new DoubleSolenoid(0, 2, 3);      
	lw->AddActuator("Lift", "pusher", liftpusher);
	
	liftshifter = new DoubleSolenoid(0, 0, 1);      

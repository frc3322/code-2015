...
DigitalInput* RobotMap::liftDetectorator1 = NULL;
DigitalInput* RobotMap::liftDetectorator2 = NULL;
...
void RobotMap::init() {
	...
	stepDetectoratorsonar = new AnalogInput(3);

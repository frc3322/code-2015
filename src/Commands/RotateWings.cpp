...
RotateWings::RotateWings(float direction, float time, float wait) {
...
void RotateWings::Execute() {
	float elapsedTime = Timer::GetFPGATimestamp() - startTime;
	if (elapsedTime > wait) {
...
bool RotateWings::IsFinished() {
	return Timer::GetFPGATimestamp()>=startTime+time + wait;
}
